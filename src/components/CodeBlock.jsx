...
function highlightLine(line) {
  const SYNTAX_COLORS = {
    'import': 'text-purple-600 font-medium',
    'from': 'text-purple-600 font-medium',
    'def': 'text-purple-600 font-medium',
    'return': 'text-purple-600 font-medium',
    'for': 'text-purple-600 font-medium',
    'in': 'text-purple-600 font-medium',
    'if': 'text-purple-600 font-medium',
    'else': 'text-purple-600 font-medium',
    'True': 'text-orange-600',
    'False': 'text-orange-600',
    'None': 'text-orange-600',
    'SELECT': 'text-blue-600 font-semibold',
    'FROM': 'text-blue-600 font-semibold',
    'WHERE': 'text-blue-600 font-semibold',
    'GROUP': 'text-blue-600 font-semibold',
    'BY': 'text-blue-600 font-semibold',
    'ORDER': 'text-blue-600 font-semibold',
    'HAVING': 'text-blue-600 font-semibold',
    'JOIN': 'text-blue-600 font-semibold',
    'AS': 'text-blue-600 font-semibold',
    'ON': 'text-blue-600 font-semibold',
    'AND': 'text-purple-600 font-medium',
    'OR': 'text-purple-600 font-medium',
    'COUNT': 'text-emerald-600',
    'SUM': 'text-emerald-600',
    'AVG': 'text-emerald-600',
          ...
          <div className="flex gap-1">
            {TABS.map(tab => (
              <button
                ...
                className={`
                  px-3 py-1 rounded-md text-xs font-semibold transition-all duration-150 border
                  ${activeTab === tab
            ...
            <tbody>
              {lines.map((line, i) => (
                <tr key={i} className="hover:bg-slate-50">
                  <td className="select-none text-right pr-4 pl-4 text-slate-300 w-12 border-r border-slate-100 py-0.5">
                    {i + 1}
                  </td>
                  <td className="pl-4 pr-6 text-slate-800 whitespace-pre py-0.5 min-w-max">
                    {highlightLine(line)}
                  </td>
                </tr>
              ))}
